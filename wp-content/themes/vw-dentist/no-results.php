...
<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-dentist' ); ?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="error-btn">
		<a class="view-more" href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-dentist' ); ?><i class="fa fa-angle-right"></i><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page','vw-dentist' );?></span></a>
	</div>
<?php endif; ?>