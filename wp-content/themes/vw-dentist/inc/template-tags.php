...
add_theme_support( 'admin-bar', array( 'callback' => 'vw_dentist_my_admin_bar_css') );
function vw_dentist_my_admin_bar_css(){
?>
 ...
 * Posts pagination.
 */
if ( ! function_exists( 'vw_dentist_blog_posts_pagination' ) ) {
	function vw_dentist_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'vw_dentist_blog_pagination_type', 'blog-page-numbers' );
