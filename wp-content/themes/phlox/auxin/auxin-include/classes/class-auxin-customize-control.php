...
class Auxin_Customize_Typography_Controller extends Auxin_Customize_Control {
    ...
    public function render_content() {?>
        <div class="aux-typo-controller aux-controller-wrapper">
            ...
            <span class="description customize-control-description aux-controller-description"><?php echo esc_html( $this->description ); ?></span>
        </div>
        <hr />
...
class Auxin_Customize_Responsive_Slider_Controller extends Auxin_Customize_Control {
    ...
    public function render_content() {?>
        ...
        <div class="aux-slider-controller aux-controller-wrapper">
            ...
            <?php if ( ! empty( $this->description ) ) { ;?> <span class="description customize-control-description aux-controller-description"><?php echo esc_html( $this->description ); ?></span> <?php } ;?>
            <hr />
        </div>
