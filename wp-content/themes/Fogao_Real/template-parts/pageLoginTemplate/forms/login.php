<form action="<?php echo wp_login_url(); ?>" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
        <div class="u-form-group u-form-name">
          ...
          <input type="text" placeholder="<?php _e( 'Username' ); ?>" id="username-a30d" name="log" class="u-border-grey-30 u-input u-input-rectangle u-input-1" required="">
        </div>
        <div class="u-form-group u-form-password">
          <label for="password-a30d" class="u-label" name=""><?php _e( 'Password' ); ?></label>
          <input type="password" placeholder="<?php _e( 'Password' ); ?>" id="password-a30d" name="pwd" class="u-border-grey-30 u-input u-input-rectangle u-input-2" required="">
        </div>
        <div class="u-form-checkbox u-form-group">
          <input type="checkbox" id="checkbox-a30d" name="rememberme" value="On">
          <label for="checkbox-a30d" class="u-label" name=""><?php _e( 'Remember Me' ); ?></label>
        </div>
