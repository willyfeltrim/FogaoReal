...
<article> 
	...
	<div class="metabox p-0">
		<span class="entry-date"><i class="far fa-calendar-alt pe-2"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
