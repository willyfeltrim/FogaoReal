	...
	<div class="content-lt">
	    <div class="container">
	        ...
	        <div class="read-moresec my-4">
	            <a href="<?php echo esc_url( home_url() ); ?>" class="button p-2"><?php esc_html_e( 'Return to Home Page', 'food-restaurant' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to home page','food-restaurant' );?></span></a>
	        </div>
