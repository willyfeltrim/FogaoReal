...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(split_add_more_button_split=="Add New Soci")
        {
			if(jQuery('#exist_burger_companion_Setto_Social').val()>=4)
				{
			 ...
			 if(jQuery('#exist_burger_companion_Setto_Social').val()<4)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Setto_Social').val())+1;
					jQuery('#exist_burger_companion_Setto_Social').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Slid")
        {
			if(jQuery('#exist_burger_companion_Setto_Slider').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_Setto_Slider').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Setto_Slider').val())+1;
					jQuery('#exist_burger_companion_Setto_Slider').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Cont")
        {
			if(jQuery('#exist_burger_companion_Setto_Contact').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_Setto_Contact').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Setto_Contact').val())+1;
					jQuery('#exist_burger_companion_Setto_Contact').val(new_service_add_val);  
				}
        }
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
               ...
               console.log( jQuery('#exist_burger_companion_OwlPress_Information,#exist_burger_companion_Crowl_Information').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Information,#exist_burger_companion_Crowl_Information').val())-1));  
				...
				if(split_delete_button_split=="Delete Socia")
                {
               console.log( jQuery('#exist_burger_companion_Setto_Social').val(parseInt(jQuery('#exist_burger_companion_Setto_Social').val())-1));  
                }
				
				if(split_delete_button_split=="Delete Slide")
                {
               console.log( jQuery('#exist_burger_companion_Setto_Slider').val(parseInt(jQuery('#exist_burger_companion_Setto_Slider').val())-1));  
                }
				
				if(split_delete_button_split=="Delete Conta")
                {
               console.log( jQuery('#exist_burger_companion_Setto_Contact').val(parseInt(jQuery('#exist_burger_companion_Setto_Contact').val())-1));  
                }
